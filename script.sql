...
-- -----------------------------------------------------
-- Table `furry-meme`.`представители_компаний`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `furry-meme`.`представители_компаний` ;

CREATE TABLE IF NOT EXISTS `furry-meme`.`представители_компаний` (
  `компания` INT(11) NOT NULL,
  `менеджер` INT(11) NOT NULL,
  INDEX `company_idx` (`компания` ASC) VISIBLE,
  CONSTRAINT `company`
