...
public enum  CommandName {
    ...
    CALCULATE_FL, CALCULATE_ROE, CALCULATE_ALL_DIFFERENTIAL_INDICATORS, CALCULATE_WACC,
    ...
    CREATE_ROE, DELETE_ROE, RECEIVE_ALL_ROE, RECEIVE_ALL_ROE_IN_LIMIT, RECEIVE_ROE, UPDATE_ROE,

    CREATE_SG, DELETE_SG, RECEIVE_ALL_SG, RECEIVE_ALL_SG_IN_LIMIT, RECEIVE_SG, UPDATE_SG
